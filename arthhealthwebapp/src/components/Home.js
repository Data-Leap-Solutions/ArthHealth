        ...
        <>
            ...
            <div className="booking-content">
                <div className="booking-title">
                    <h1>Welcome to your journey of recovery</h1>
                    <p>Explore our services and schedule an appointment that best fits your needs.</p>
                </div>
                {/* Uncomment below to show the booking links */}
                {/* <div className="booking-links">
                    <ul>
                        <li><Link to="/book-appointment">Request an Appointment</Link></li>
                        <li><Link to="/services/complimentary-screening">Complimentary Screening</Link></li>
                    </ul>
                </div> */}
            </div>
